...
$(document).ready(function () {
	...
	table = $('#tabelrate').DataTable({
		...
		"ajax":
		{
			"url": base_url +"kurs/getdatarate", // URL file untuk proses select datanya
			"type": "POST",
			"data": function(d){
				// d.filt = $('#katbar').val();
				// // d.exdo = $('#exdonya').val();
	...
	tablekmk = $('#tabelkmk').DataTable({
		...
		"ajax":
		{
			"url": base_url +"kurs/getdatakmk", // URL file untuk proses select datanya
			"type": "POST",
			"data": function(d){
				// d.filt = $('#katbar').val();
				// // d.exdo = $('#exdonya').val();
