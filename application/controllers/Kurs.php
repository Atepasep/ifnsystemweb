...
class Kurs extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('kurs_model','kursmodel');
    ...
    public function getdatarate($mode=''){
        $arrayu = [];
        ...
        // }
        echo $this->kursmodel->getdatarate($arrayu,$mode);
    }
    public function getdatakmk($mode=''){
        $arrayu = [];
        // $filter_kategori = $_POST['filt'];
        // // $filter_exdo = $_POST['exdo'];
        // $filter_stok = $_POST['stok'];
        ...
        //     $arrayu['nomor_bc'] = $filter_nombc;
        // }
        echo $this->kursmodel->getdatakmk($arrayu,$mode);
    }
    // End Controller
