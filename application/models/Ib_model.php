...
class Ib_model extends CI_Model
{
    ...
    public function getnomorib($bl, $th)
    {
        ...
        WHERE kode_dok = 'IB' AND MONTH(tgl)='" . $bl . "' AND YEAR(tgl)='" . $th . "' AND dept_tuju = '" . $this->session->userdata('curdeptin') . "' AND LEFT(nomor_dok,3) = 'SU-' ")->row_array();
        return $hasil;
    }
    ...
    public function getbarangib($sup = '')
    {
        ...
        $this->db->order_by('a.tgl DESC, a.nomor_dok DESC');
        return $this->db->get();
    }
