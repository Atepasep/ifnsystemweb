                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tabs-home-1">
                          <div class="row">
                            ...
                            <div class="col-4">
                              ...
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="master24" name="master24" type="checkbox" <?= cekceklis($user['master'], 24); ?>>
                            ...
                            <div class="col-4">
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="master27" name="master27" type="checkbox" <?= cekceklis($user['master'], 27); ?>>
                                <span class="form-check-label">Kurs</span>
                              </label>
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="master28" name="master28" type="checkbox" <?= cekceklis($user['master'], 28); ?>>
                          ...
                          <div class="row">
                            <div class="col-6">
                              ...
                              <label class="form-check mb-1">
                                ...
                                <span class="form-check-label">Barang Modal & Sparepart</span>
                              </label>
                              <label class="form-check mb-1">
                        ...
                        <div class="tab-pane" id="tabs-setting-1">
                          <div class="row">
                            ...
                            <div class="col">
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="setting2" name="setting2" type="checkbox" <?= cekceklis($user['setting'], 2); ?>>
                        ...
                        <div class="tab-pane" id="tabs-hakdowntime-1">
                          <div class="row">
                            <div class="col">
                              ...
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="hakdowntime7" name="hakdowntime7" type="checkbox" <?= cekceklis($user['hakdowntime'], 7); ?>>
                                <span class="form-check-label">CV Arroza</span>
                              </label>
                            </div>
                          </div>
                        </div>
