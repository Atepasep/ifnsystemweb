                        ...
                        <div class="tab-pane active show" id="tabs-hakprogram-1">
                          <div class="row">
                            <div class="col-6">
                              ...
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="hakprogram7" name="hakprogram7" type="checkbox">
                        ...
                        <div class="tab-pane" id="tabs-home-1">
                          <div class="row">
                            ...
                            <div class="col-4">
                              ...
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="master26" name="master26" type="checkbox">
                        ...
                        <div class="tab-pane" id="tabs-hakdowntime-1">
                          <div class="row">
                            ...
                            <div class="col">
                              ...
                              <label class="form-check mb-1">
                                <input class="form-check-input" id="hakdowntime7" name="hakdowntime7" type="checkbox">
