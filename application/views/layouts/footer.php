...
<?php } ?>
<?php if (isset($fungsi) && $fungsi == 'netplan') { ?>
	<script src="<?= base_url(); ?>assets/js/own/netplan.js?<?= $updatejs; ?>"></script>
<?php } ?>
...
<?php } ?>
<?php if (isset($fungsi) && $fungsi == 'warna') { ?>
	<script src="<?= base_url(); ?>assets/js/own/warna.js?<?= $updatejs; ?>"></script>
<?php } ?>
