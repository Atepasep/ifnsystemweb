                            ...
                            <?php 
                             ...
                             ?>
                                <tr>
                                    ...
                                    <td class="font-kecil text-end line-11">
                                        ...
                                        <?php elseif($dt['status_hikiai']==3): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <?php if($dt['status_hikiai']>=5 && $dt['status_hitung']==2): ?>
                                                <a href="<?= base_url().'ponet/viewjawabhikiai/'.$dt['id'] ?>" class="btn btn-smx btn-flat btn-primary font-kecil">View Verifikasi</a>
                                            <?php else: ?>
                                                <span class="text-cyan">Data Sudah Dikirim</span><br>
                                                <span class="text-cyan">Belum Verifikasi Marketing</span>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
